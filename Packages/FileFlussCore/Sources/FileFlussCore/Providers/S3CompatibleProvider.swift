...
public final class S3CompatibleProvider: CloudProvider, @unchecked Sendable {
    public let providerType: CloudProviderType = .s3Compatible
    ...
    public static func host(fromEndpoint endpoint: String) -> String {
