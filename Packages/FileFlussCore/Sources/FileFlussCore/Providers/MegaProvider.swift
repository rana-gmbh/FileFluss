...
public final class MegaProvider: CloudProvider, @unchecked Sendable {
    public let providerType: CloudProviderType = .mega
    ...
    public func authenticate(email: String, password: String, mfaCode: String? = nil) async throws {
